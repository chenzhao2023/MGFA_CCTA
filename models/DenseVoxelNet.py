...
class DenseVoxelNet(BaseModel):
    ...
    def __init__(self, in_channels=1, classes=1):
        ...
        self.dense_1 = _DenseBlock(num_layers=12, num_input_features=num_input_features, bn_size=1, growth_rate=12,drop_rate=0)
...
# model = DenseVoxelNet(in_channels=1, classes=1)
# model.test()